...
int main(){
  ...
  while(running){
    ...
    */
    ...
    cout << "What notation would you like it to be printed out as? Enter prefix, infix, or postfix. case sensitive." << endl;
    ...
    cout << endl;
    if(strcmp("infix", input) == 0){
      cout << "Infix:" << endl;
      printInfix(treeHead);
    }
    cout << endl;
    if(strcmp("postfix", input) == 0){
